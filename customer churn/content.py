                                ...
                                dbc.InputGroup(
                                    [
                                        ...
                                        dbc.Select(
                                            ...
                                            ], id = "categorical_dropdown", value="Contract"
                                        )
                                    ]
                                ),


                                html.Img(src="../assets/churn.png", className="churn-img")
                        ...
                        [
                            dbc.InputGroup(
                                [
                                    ...
                                    dbc.Input(
                                        id="ft_tenure",
                                        placeholder="Months", type="number", value="4"
                                    ),
                                ]
                            )
                        ], lg="3", sm=12
...
tab_prediction_result = dbc.Card(
                    ...
                    dbc.Col(
                        [
                            dbc.Card(
                                dbc.CardBody(
                                    [
                                        dbc.Spinner(html.H4(id="svm_result", children="-", style={'color':'#070707'}), size="sm", spinner_style={'margin-bottom': '5px'}),
                                        html.P("SVM")
                                    ]
    ...
    className="mt-3", style = {"background-color": "#070707"}
)
